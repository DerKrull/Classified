...
public class Spiel {
  ...
  public void frage8() {
    ...
    choice2.setText("Ach, das passt schon ich hab andere Quellen die mich unterstützen, da\"\nmuss"
        + " ich selbst nicht arbeiten gehen");
    choice3.setVisible(false);
    choice4.setVisible(false);
  ...
  public void frage11() {
    ...
    questionTextArea.setText("In der Uni steht die erste Prüfung kurz vor der Tür,\ngleichzeitig"
         + " hat aber auch dein bester Freund seinen 18. Geburtstag. Was machst du? ");
  ...
  public void frage12() {
    ...
    questionTextArea.setText("Du warst feiern und wachst am Morgen der Prüfung in einem Regio\nin"
        + " Erfurt auf und wunderst dich wie du es soweit geschafft hast ");
      ...
      switch (id) {
        ...
        case 5:
          switch (yourChoice) {
            case "a1": frage4(); 
            break;
            case "a2": JOptionPane.showMessageDialog(null, "TIPP: Eine Lerngruppe hilft den"
                + " Stoff nocheinmal zu wiederholen\" \nund in der Gruppe zu besprechen\"");
                frage4(); 
                break;
          }
          break;
        ...
        case 7 :
          switch (yourChoice) {
            case "a1": JOptionPane.showMessageDialog(null, "Du hast es geschafft und die Prüfung"
                + " bestanden.\\nUnd jetzt\"\ngeht's weg von der Uni ab nach Hause ins"
                + " Privatleben");
                frage6(); 
                break;
        ...
        case 9 :
          switch (yourChoice) {
            ...
            case "a2": JOptionPane.showMessageDialog(null, "Du wohnst alleine und kannst machen" 
                ...
                + " Allerdings"
                + " ist die Wohnung nicht ganz günstig!");
              frage8(); 
              break;
          }
          break;
