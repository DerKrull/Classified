...
public class Spiel {
  ...
  public void frage8() {
    ...
    choice1.setText("Das hört sich vernünftig an, dann bin ich \n maximal"
         + " selbstständig");
    choice2.setVisible(true);
    choice2.setText("Ach, das passt schon ich hab andere Quellen die mich unterstützen,"
  ...
  public void frage33() {
    id = 35;
    choiceButtonPanel.setBounds(370, 520, 450, 200);
    questionTextArea.setText("Du hast dich verschätzt und hast nicht geschafft dich gut"
         + " vorzubreiten.");
    choice1.setText(weiter);
    choice2.setVisible(false);
    choice3.setVisible(false);
  ...
  public void ende() {
    id = 39;
    choiceButtonPanel.setBounds(370, 520, 450, 200);
    questionTextArea.setText("Hier endet dein Aufstieg als Informatiker. Vielen dank für das"
         + " Spielen. ");
  ...
  public class ChoiseHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
      ...
      String belegstFaecher = "Du belegst 3 Fächer deiner Spezialisierung.";
        ...
        case 9 :
          switch (yourChoice) {
            ...
            case "a2": JOptionPane.showMessageDialog(null, "Du wohnst alleine und kannst machen"
                 ...
                 + " Allerdings ist die Wohnung nicht ganz günstig!");
              frage8(); 
              break;
            default: break;
          }
        ...
        case 18:
          switch (yourChoice) {
            ...
            case "a4": JOptionPane.showMessageDialog(null, belegstFaecher);
              frage17(); 
              break;
            case "a5": JOptionPane.showMessageDialog(null, "Du belegst 3 Fächer deiner"
                 + " Wahl.");
              frage17(); 
              break;
            default: break;
        ...
        case 1000:
          switch (yourChoice) {
            ...
            case "a4": JOptionPane.showMessageDialog(null, belegstFaecher);
              frage21(); 
              break;
            case "a5": JOptionPane.showMessageDialog(null, "Du belegst 3 Fächer deiner Wahl.");
              frage21(); 
              break;
            default: break;
          }
